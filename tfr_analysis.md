...
%% Now to visualise the Grand Average Results
...
cfg.parameter = 'pow';
ft_multiplotTFR(cfg, freqdiff_LR)
figure;
ft_multiplotTFR(cfg, freqdiff_VO)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% From the grand average plots, there are prominent differences in
% oscillatory power from 1-7Hz. We are therefore statistically testing for
% differences in theta between conditions, as in Wang et al, (2016).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
